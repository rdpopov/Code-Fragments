...
" Description:
"
" This is a utility that can get what is under visual selection and then ...
" well add your won stuffand execute it, it can open things in browser(brave
" works) add your won tho if you dont like thes, tho the function that gets
" the visual selection is waaay over my understanding
"
